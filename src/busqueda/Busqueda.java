...
public class Busqueda {
    ...
    public static void main(String[] args) {
        int numArray= Integer.parseInt(JOptionPane.showInputDialog("Introduce numero del array:"));
        int numValor= Integer.parseInt(JOptionPane.showInputDialog("Introduce valor que quieres averiguar:"));
